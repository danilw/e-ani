...
puppet func update_tranform(transformx,transformxb):
	get_node("../").transform=transformx
	get_node("../model/Spatial").transform=transformxb
...
func _process(delta):
	...
	if(del_it):
		...
		rpc("update_tranform",get_node("../").transform,get_node("../model/Spatial").transform)
