...
var player_pos2=Vector3() #player pos
var player_rot2=0 #rotation for camera
var FPS_s=1.0 
var iMouse=Vector3() #mouse xy
var iMouse2=Vector3() #mouse xy
var iMouse_d=Vector2() #mouse press
var iMouse_d2=Vector2() #mouse press
var iMouse_3d=Vector3() #camera mouse
var iMouse_3d_normal=Vector3() #camera mouse
var iMouse_3d2=Vector3() #camera mouse
var iMouse_3d_normal2=Vector3() #camera mouse
...
var mouse_aim_e2=false #setting
var mouse_aim_ee2=false #setting
var eh_pos=Vector3()
var ehtime=-10.0
var no_parts=false #setting
var ftime_b=-10.0

# multiplayer fix, ids, also look player_l/2.gl tidsx_l/r, and enemy_spwner.gd
var en_bulids=0
var ches_ids=0
var enemys_ids=0
var bonus_ids=0
...
master func upd_imouse(im,id,ir):
	var tim=Vector2(im.x,im.y)/Vector2(ir.y,ir.y)-(ir/Vector2(ir.y,ir.y))/2.0
	tim=tim*Vector2(iResolution.y,iResolution.y)+(iResolution)/2.0
	iMouse2=Vector3(tim.x,tim.y,im.z)
	iMouse_d2=id
...
func _process(delta):
	...
	if(!is_network_master()):
		rpc("upd_imouse",iMouse,iMouse_d,iResolution)
