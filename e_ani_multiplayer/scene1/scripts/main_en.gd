...
func _process(delta):
	...
	get_node("shield/s").process_material.set("shader_param/ppos2",global_v.player_pos2)
	...
	get_node("shield/s2").process_material.set("shader_param/ppos2",global_v.player_pos2)
