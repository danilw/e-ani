...
func _on_ssr_pressed():
	var ov=get_node("../main_camera").environment.is_ssr_enabled()
	get_node("../main_camera").environment.set_ssr_enabled(!ov)
...
func _on_fow_value_changed(value):
	get_node("../main_camera").set_fov(value)
...
func _on_glow_pressed():
	var ov=get_node("../main_camera").environment.is_glow_enabled()
	get_node("../main_camera").environment.set_glow_enabled(!ov)
